...
function PIEchangeDisplayText(b, d) {
    ...
    var c;
    a = null;
    for (c = 0; (a == null) && (c < PIEitDisplay); c++) {
...
function PIEgetDisplayText(a) {
    ...
    var c;
    d = false;
    for (b = 0; (d == false) && (b < PIEitDisplay); b++) {
...
function PIEgetInputText(a) {
    ...
    var c;
    d = false;
    for (b = 0; (d == false) && (b < PIEitInput); b++) {
...
function PIEchangeDisplaySlider(b, d) {
    ...
    var c;
    a = null;
    for (c = 0; (a == null) && (c < PIEsDisplay); c++) {
...
function PIEgetDisplaySlider(a) {
    ...
    var c;
    d = false;
    for (b = 0; (d == false) && (b < PIEsDisplay); b++) {
...
function PIEchangeDisplayCheckbox(b, d) {
    ...
    var c;
    a = null;
    for (c = 0; (a == null) && (c < PIEcbDisplay); c++) {
...
function PIEgetDisplayCheckbox(a) {
    ...
    var c;
    d = false;
    for (b = 0; (d == false) && (b < PIEcbDisplay); b++) {
...
function PIEchangeDisplayCommand(c, b, d) {
    ...
    var e;
    a = null;
    for (e = 0; (a == null) && (e < PIEcDisplay); e++) {
